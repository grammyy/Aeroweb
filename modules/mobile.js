setInterval(function(){
    if(webpage.getBoundingClientRect().width<710){
        ...
        if(webpage.children[4].tagName!="IFRAME")webpage.children[3].insertAdjacentHTML("afterend","<iframe src='./programs/mobile.html' style='margin-bottom:31%;bottom:0;height:10px'></iframe>")
